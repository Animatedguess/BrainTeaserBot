                            ...
                            <div className="lg:max-w-lg opacity-100">
                                ...
                                <div className="flex flex-col mt-6 space-y-3 lg:space-y-0 lg:flex-row">
                                    <input
                                        ...
                                        type="text"
                                        className="px-4 w-3/4 py-2 border rounded-md bg-gray-800 text-gray-300 dark:border-gray-600 focus:border-blue-300 focus:outline-none focus:ring focus:ring-opacity-40 focus:ring-blue-300"
                                        placeholder="Ask your question here..."
                                    />
                                    <button
                                        onClick={() => setButtonClicked(!buttonClicked)}
                                        className="w-1/4 px-5 py-2 text-sm tracking-wider text-white transition-colors duration-300 transform bg-landing-color rounded-lg lg:w-auto lg:mx-4 hover:bg-gray-400 focus:outline-none focus:bg-landing-color"
                                    >
                                        Ask AI
                                    </button>
                                </div>
